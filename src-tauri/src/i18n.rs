pub struct Translations {
    ...
    pub thermal_nominal_short: &'static str,
    pub thermal_fair_short: &'static str,
    pub thermal_serious_short: &'static str,
    pub thermal_critical_short: &'static str,
...
const ENGLISH: Translations = Translations {
    ...
    thermal_nominal_short: "NOM",
    thermal_fair_short: "FAIR",
    thermal_serious_short: "HIGH",
    thermal_critical_short: "CRIT",
...
const SPANISH: Translations = Translations {
    ...
    thermal_nominal_short: "NOM",
    thermal_fair_short: "MOD",
    thermal_serious_short: "GRAV",
    thermal_critical_short: "CRIT",
...
const CHINESE: Translations = Translations {
    ...
    thermal_serious: "严重",
    thermal_critical: "危急",
    thermal_nominal_short: "正常",
    thermal_fair_short: "一般",
    thermal_serious_short: "严重",
    thermal_critical_short: "危急",
