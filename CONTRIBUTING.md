...
`.github/workflows/testflight.yml`, `scripts/build-appstore-bundle.sh`,
`scripts/setup-appstore-signing.sh`, `scripts/upload-appstore-package.sh`,
`src-tauri/tauri.appstore.conf.json`, `src-tauri/Cargo.lock`, and
